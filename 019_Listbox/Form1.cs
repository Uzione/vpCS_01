...
namespace _019_Listbox
{
    public partial class Listbox : Form
    {
        ...
        private void Listbox_Load(object sender, EventArgs e)
        {
            ...
            {
                "필란드", "덴마크", "아이슬란드", "스위스", "네덜란드", "룩셈부르크", "스웨덴", "노르웨이", "이스라엘", "뉴질랜드"
            };
        ...
        private void listBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            tSIndex1.Text = (l.SelectedIndex + 1).ToString();
            tSItem1.Text = l.SelectedItem.ToString();
        }

        private void listBox2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ListBox l = sender as ListBox;
            tSIndex2.Text = (l.SelectedIndex + 1).ToString();
            tSItem2.Text = l.SelectedItem.ToString();
        }

        private void listBox3_SelectedIndexChanged(object sender, EventArgs e)
        {
            ListBox l = sender as ListBox;
            tSIndex3.Text = (l.SelectedIndex + 1).ToString();
            tSItem3.Text = l.SelectedItem.ToString();
        }
    }
}
